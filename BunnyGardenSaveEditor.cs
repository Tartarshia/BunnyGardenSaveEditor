...
internal sealed class EditorForm : Form
{
    ...
    public EditorForm()
    {
        ...
        calendarCard.Controls.Add(new Label { Text = "凛　　生日邀请 07-01　·　旅行邀请 08-06　·　生日 / 原创香槟 09-03　·　告白判定 09-17", Left = 16, Top = 54, Width = 830, Height = 20, ForeColor = Ink, BackColor = Card });
        calendarCard.Controls.Add(new Label { Text = "美羽香　生日邀请 07-08　·　旅行邀请 08-20　·　生日 / 原创香槟 08-27　·　告白判定 09-17", Left = 16, Top = 75, Width = 830, Height = 20, ForeColor = Ink, BackColor = Card });
        characterTab.Controls.Add(new Label { Text = "旅行实际出发日不固定：拿到邀请后选择可用周末；9/24 是告白 / Good End 的最后补救点。", Left = 14, Top = 148, Width = 850, Height = 22, ForeColor = Color.FromArgb(134, 106, 125), BackColor = PalePink });
        characterList.SetBounds(14, 174, 872, 278); characterList.View = View.Details; characterList.FullRowSelect = true; characterList.GridLines = true; characterList.Columns.Add("角色", 70); characterList.Columns.Add("剧情", 55); characterList.Columns.Add("未互动天数", 82); characterList.Columns.Add("After", 55); characterList.Columns.Add("高级 After", 75); characterList.Columns.Add("ASMR", 55); characterList.Columns.Add("旅行", 90); characterList.Columns.Add("生日邀请", 75); characterList.Columns.Add("生日礼物", 75); characterList.Columns.Add("告白", 80); characterList.Columns.Add("感谢内裤", 105); characterList.Columns.Add("裤袜", 105); characterTab.Controls.Add(characterList);
